...
import { Users } from 'src/users/entities/users.entity'; // Assuming there is a User entity defined
import { TransactionBasketItems } from './transaction_basket_items.entity'; // Assuming there is a TransactionBasketItem entity defined
import { v4 as uuidv4 } from 'uuid';
import { Redemption } from './redemptions.entity';

@Entity('mf_redemption_plans')
export class MfRedemptionPlan {
  ...
  @ManyToOne(() => Users, (user) => user.mf_redemption_plans)
  ...
  @OneToMany(() => Redemption, (redemptions) => redemptions.mf_redemption_plan)
